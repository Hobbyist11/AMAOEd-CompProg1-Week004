...
//DECLARE
  ...
  while(seatnumber != 1597){
    ...
    if(seatnumber >= 1 && seatnumber < 36 && seat[row_finder][column_finder] != zero){
    ...
    else if(seat[row_finder][column_finder] == "X  "){
      std::cout<< endl;
    std::cout<< "Seat taken";
    std::cout<<endl;
    std::cout<<endl;
 ...
 std::cout << "Seats are successfully reseved!";
        // ********************** DO NOT CHANGE **********************
